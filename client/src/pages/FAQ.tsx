...
const faqData: FAQCategory[] = [
  ...
  },
  {
    ...
    items: [
      {
        question: "How does Well Estate Group compare to Forward Health or Parsley Health?",
        answer: "Forward and Parsley focus on primary care with technology enhancement. Well Estate Group is fundamentally different: we're a diagnostics and regenerative medicine company with hospitality-grade service. Our GeneMetrics™ platform provides proprietary insights, and our stem cell/regenerative capabilities are unique in the membership medicine space.",
      },
      {
        question: "What about traditional concierge medicine practices?",
        answer: "Traditional concierge practices charge $5,000-$25,000 annually for enhanced access to a single physician. Well Estate Group offers comprehensive diagnostics, regenerative treatments, and ongoing care at comparable pricing but with far more clinical capability. Our vertically integrated model (diagnostics, biologics, treatments) creates value traditional practices can't match.",
      },
      {

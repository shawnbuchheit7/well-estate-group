    ...
    <Layout>
      ...
      <section className="py-20 relative">
        <div 
          ...
          style={{ backgroundImage: "url('https://files.manuscdn.com/user_upload_by_module/session_file/310519663219582709/lBacSJKiGBzTAfSP.png')" }}
        />
            ...
            {[
              {
                ...
                icon: Dna,
                description: "Revolutionary pluripotent stem cells with superior homing ability and differentiation potential. Well Estate Group holds exclusive U.S. distribution rights.",
                highlights: [
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  {[
                    ...
                    },
                    {
                      ...
                      requirements: [
                        "Dedicated staff for Well Estate Group protocols",

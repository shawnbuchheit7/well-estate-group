          ...
          >
            {focusDriveMarkets.map((market, i) => (
              <motion.div
                ...
                className="w-36 h-36 md:w-40 md:h-40 rounded-full border border-[#B8860B]/40 bg-white hover:border-[#B8860B] hover:bg-[#B8860B]/[0.06] flex items-center justify-center p-4 transition-colors duration-300 cursor-default shadow-[0_4px_20px_rgba(201,169,98,0.08)]"
              >
        ...
        <div className="container">
          ...
          >
            {lobTargeting.map((lob, i) => (
              ...
              >
                <div className="flex items-center gap-3 px-5 py-3.5 border-b border-[#B8860B]/40 bg-[#FAFAF8]">

        ...
        <div className="container">
          ...
          >
            {macroLobs.map((lob, i) => (
              ...
              >
                <div className="bg-white border border-black/[0.12] rounded-2xl p-7 h-full hover:border-[#C9A962]/40 hover:shadow-lg transition-all duration-300 text-center relative overflow-hidden">
                  {/* Background accent */}

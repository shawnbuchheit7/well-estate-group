...
const macroLobs: MacroLob[] = [
  {
    ...
    priceValue: "$825",
    tier: "Tier 1 — Launch",
    persona: "The Premium Member Experience Director",
    personaTitle: "Member Experience Director",
    painPoints: [
    ...
    gtmPositioning: "Market as bespoke, data-driven core training experience exclusive to the club. Personal trainers offer premium one-on-one sessions with real-time performance tracking. Sleek design and connected app reinforce technology-forward brand identity.",
    keySelling: ["Sleek design", "App-driven personalization", "Exclusivity factor", "Trainer-led programming potential"],
  ...
  },
  {
    ...
    personaTitle: "Fitness Director",
    painPoints: [
      "Traditional ab wheels break frequently and need constant replacement",
    ...
    gtmPositioning: "Durable, motorized replacement that integrates into HIIT classes and personal training. Rochester Athletic Club expanded to 6 units serving 16,000+ members, with plans for fee-based 'core clinics' as new revenue source. Connected app provides anti-theft protection and remote device management.",
    keySelling: ["Durability and cost savings", "Group class versatility", "New revenue potential (core clinics)", "Connected device management"],
  ...
  },
  {
    ...
    priceValue: "$825",
    tier: "Tier 1 — Launch",
    persona: "The Clinical Rehabilitation Director",
    personaTitle: "Clinical Rehab Director / Lead PT",
    painPoints: [
  ...
  },
  {
    ...
    priceValue: "$825",
    tier: "Tier 2 — Growth",
    persona: "The Luxury Property Manager",
    personaTitle: "Property Manager / Wellness Concierge",
    painPoints: [
      "Limited gym space in luxury buildings — every square foot matters",
      "Equipment must serve beginners and advanced users alike",
      "Residents expect premium, self-guided experience without dedicated staff",
    ],
    gtmPositioning: "Emphasize compact footprint (18\" x 8.4\" x 8.4\") and ability to deliver full-body workout from single device. QR code onboarding and intuitive app enable safe, unassisted use. Elevates property's wellness brand without consuming valuable floor space.",
    keySelling: ["Compact design (18\" x 8.4\")", "Self-guided onboarding (QR)", "Broad demographic appeal", "Premium aesthetic"],
  ...
  },
  {
    ...
    priceValue: "$694",
    tier: "Tier 3 — Scale",
    persona: "The Tactical Strength & Conditioning Facilitator",
    personaTitle: "TSAC-F / Installation Fitness Director",
    painPoints: [
      "Need equipment that deploys anywhere — base, field, ship",
      "Must serve diverse population from recruits to seasoned operators",
  ...
  },
  {
    ...
    priceValue: "$825",
    tier: "Tier 3 — Scale",
    persona: "The Onboard Wellness Director",
    personaTitle: "Cruise Line Fitness Director",
    painPoints: [
    ...
    gtmPositioning: "Compact footprint is ideal for space-constrained vessel fitness centers. One Spa World partnership opens access to 144+ vessels. Scalable difficulty serves the full passenger demographic from senior wellness to athlete training. Connected app enables fleet-wide device management and usage analytics.",
    keySelling: ["Ultra-compact for vessel gyms", "One Spa World (144+ vessels)", "Fleet-wide device management", "Full demographic scalability"],
    subs: ["Cruise Line Fitness Centers", "Superyacht Installations", "One Spa World (144+ Vessels)", "Marine Fitness Distributors"],
  },
];

const summaryTable = [
  { vertical: "Private Clubs", decisionMaker: "Member Experience Director", painPoint: "Member retention & novelty", uvp: "Luxury, bespoke core training" },
  { vertical: "Commercial Fitness", decisionMaker: "Fitness Director", painPoint: "Equipment breakage & utilization", uvp: "Durable, versatile, new revenue" },
  { vertical: "Medical & Rehab", decisionMaker: "Clinical Rehab Director", painPoint: "Patient safety & progress data", uvp: "CKC science, graduated assistance" },
  ...
  { vertical: "Hospitality & Amenities", decisionMaker: "Property Manager", painPoint: "Limited space, no staff", uvp: "Space-saving, self-guided" },
  { vertical: "Military & Government", decisionMaker: "TSAC Facilitator", painPoint: "Portability & GSA compliance", uvp: "Rugged, portable, US Army endorsed" },
  { vertical: "Cruise & Maritime", decisionMaker: "Onboard Wellness Director", painPoint: "Extreme space constraints", uvp: "Ultra-compact, fleet management" },
];
          ...
          >
            <div className="rounded-2xl border-2 border-black/[0.15] overflow-hidden shadow-[0_4px_20px_rgba(0,0,0,0.04)]">
              <div className="bg-[#0A0A0A] px-8 py-4 flex items-center justify-between">
                ...
                <span className="font-mono text-[10px] text-[#C9A962] tracking-wider">MSRP $1,095 — DO NOT EXCEED THRESHOLDS</span>
              </div>
                    ...
                    <div className="px-6 py-5 flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 ${
                          isExpanded ? "bg-[#C9A962]/15" : "bg-black/[0.04] group-hover:bg-[#C9A962]/10"
                        }`}>
                          <Icon className={`w-5 h-5 transition-colors ${isExpanded ? "text-[#C9A962]" : "text-black/40 group-hover:text-[#C9A962]"}`} />
                        </div>
                        <div>
                          <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        >
                          <ChevronDown className={`w-5 h-5 transition-colors ${isExpanded ? "text-[#C9A962]" : "text-black/25"}`} />
                        </motion.div>
                      </div>
                    </div>
                          ...
                          <div className="px-6 pb-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                              ...
                              <div className="space-y-5">
                                ...
                                <div>
                                  <div className="flex items-center gap-2 mb-2">
                                    <UserCircle className="w-3.5 h-3.5 text-[#C9A962]" />
                                    <span className="font-mono text-[9px] text-[#C9A962] tracking-[0.15em] uppercase font-semibold">Buyer Persona</span>
                                  </div>
                              ...
                              <div className="space-y-5">
                                ...
                                <div>
                                  <div className="flex items-center gap-2 mb-2">
                                    <Crosshair className="w-3.5 h-3.5 text-[#C9A962]" />
                                    <span className="font-mono text-[9px] text-[#C9A962] tracking-[0.15em] uppercase font-semibold">GTM Positioning</span>
                                  </div>
                                ...
                                <div>
                                  <div className="flex items-center gap-2 mb-2.5">
                                    <ArrowRight className="w-3.5 h-3.5 text-[#C9A962]" />
                                    <span className="font-mono text-[9px] text-[#C9A962] tracking-[0.15em] uppercase font-semibold">Sub-Segments ({lob.subs.length})</span>
                                  </div>
                                  <div className="flex flex-wrap gap-1.5">
                                    {lob.subs.map((sub, j) => (
                                  ...
                                  <div className="bg-[#0A0A0A] rounded-xl p-4 mt-3">
                                    ...
                                    <div className="mt-2.5 flex items-center gap-2">
                                      <div className="w-5 h-5 rounded-full bg-[#C9A962]/20 flex items-center justify-center">
                                        <span className="text-[8px] text-[#C9A962] font-bold">{lob.testimonial.author[0]}</span>
                                      </div>
                                      <div>
                  ...
                  <tbody>
                    {summaryTable.map((row, i) => (
                      ...
                      >
                        ...
                        <td className="p-4">
                          <span className="font-body text-xs text-[#C9A962] font-medium">{row.uvp}</span>
                        </td>
                      </tr>
                    ))}
                  </tbody>

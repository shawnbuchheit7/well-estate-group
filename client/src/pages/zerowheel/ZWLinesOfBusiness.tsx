          ...
          >
            {allLobs.map((lob, i) => (
              <motion.div
                ...
                className="aspect-square rounded-full border-2 border-black/[0.08] hover:border-[#C9A962]/60 flex items-center justify-center p-4 bg-white hover:bg-[#C9A962]/[0.04] transition-colors duration-300 cursor-default shadow-[0_4px_16px_rgba(0,0,0,0.04)]"
              >
        ...
        <div className="container">
          ...
          >
            {macroLobs.map((lob, i) => (
              ...
              >
                <div className="bg-white border border-black/[0.08] rounded-2xl p-7 h-full hover:border-[#C9A962]/40 transition-all duration-300 text-center relative overflow-hidden">
                  {/* Background accent */}

          ...
          >
            {globalRegions.map((region, i) => (
              ...
              >
                ...
                <div className="p-6">
                  <p className="font-body text-sm text-black/55 mb-4">{region.description}</p>
                  <div className="mb-4">
                    <p className="font-mono text-[10px] text-black/60 uppercase tracking-[0.15em] mb-2">Active LOBs</p>
                  ...
                  {region.partners && (
                    <div>
                      <p className="font-mono text-[10px] text-black/60 uppercase tracking-[0.15em] mb-2">Key Partners</p>
                      <div className="flex flex-wrap gap-1.5">
                        ...
                        {region.cities.map((city, j) => (
                          ...
                          >
                            <div className="flex items-center justify-center gap-1">
                              ...
                              <span className="font-body text-[10px] text-black/65">{city}</span>
                            </div>
                          </motion.div>
                        ))}
                      </motion.div>

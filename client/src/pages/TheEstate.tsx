      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden" style={{ background: DARK }}>
        ...
        <motion.div className="relative z-10 px-8 md:px-16 max-w-5xl mx-auto w-full text-center" style={{ y: heroY, opacity: heroOpacity }}>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.h1 variants={fadeUp} className="font-estate text-5xl md:text-7xl lg:text-[6.5rem] font-light leading-[0.92] tracking-[-0.02em] mb-10" style={{ color: IVORY }}>
              Where Vitality<br />
              is the Ultimate<br />
            ...
            <motion.div variants={fadeUp} className="flex flex-wrap justify-center gap-12 md:gap-16 border-t pt-10" style={{ borderColor: "rgba(250,247,242,0.12)" }}>
              {[
                ...
                <div key={i} className="text-center">
                  <div className="font-estate text-3xl md:text-4xl font-light" style={{ color: IVORY }}>
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="mb-16 md:mb-20">
              ...
              <h2 className="font-estate text-4xl md:text-6xl font-light" style={{ color: DARK }}>
            ...
            >
              {founders.map((founder, i) => (
                ...
                >
                  ...
                  {/* Name */}
                  <h4 className="font-estate text-lg md:text-xl font-medium mb-1" style={{ color: DARK }}>
                    {founder.name}
                  </h4>
                  {/* Role — muted */}
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="text-center mb-16 md:mb-20">
              <h2 className="font-estate text-3xl md:text-5xl lg:text-[3.5rem] font-light leading-[1.2]" style={{ color: DARK }}>
            ...
            <motion.div className="grid grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6" variants={stagger}>
              {pillars.map((pillar, i) => (
                <motion.div key={i} variants={fadeUp} className="text-center">
                  ...
                  <h3 className="font-estate text-xl md:text-2xl font-light mb-3" style={{ color: DARK }}>
                    {pillar.name}
                  </h3>
      ...
      <section className="py-28 md:py-40" style={{ background: DARK }}>
        <div className="max-w-5xl mx-auto px-8 md:px-16">
          ...
          >
            <motion.h2
              variants={fadeUp}
              className="font-estate text-3xl md:text-5xl lg:text-6xl font-light leading-[1.2] tracking-tight mb-12"
              style={{ color: IVORY }}
            >
              Where Vitality is the Ultimate Luxury.
            </motion.h2>
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          ...
          >
            <motion.div variants={fadeUp} className="mb-20">
              ...
              <h2 className="font-estate text-4xl md:text-6xl font-light" style={{ color: IVORY }}>
            ...
            <div className="grid md:grid-cols-3 gap-px" style={{ background: "rgba(255,255,255,0.08)" }}>
              {ecosystem.map((item, i) => (
                ...
                >
                  <h3 className="font-estate text-2xl font-light mb-4" style={{ color: IVORY }}>
                    {item.type}
                  </h3>
              ...
              {destinations.map((dest, i) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 md:p-6">
                    ...
                    <h4 className="font-estate text-xl font-light" style={{ color: IVORY }}>
                      {dest.name}
                    </h4>
          ...
          >
            ...
            <motion.div variants={fadeUp} className="grid md:grid-cols-3 gap-12 md:gap-16">
              {[
                ...
                <div key={i}>
                  <div className="font-estate text-4xl md:text-5xl font-light mb-4" style={{ color: DARK }}>
                    {stat.value}
                  </div>
            ...
            <motion.div variants={fadeUp} className="mt-20 pt-12" style={{ borderTop: "1px solid rgba(10,10,10,0.08)" }}>
              <p className="font-estate text-2xl md:text-3xl font-light leading-relaxed max-w-4xl" style={{ color: DARK }}>
      ...
      <section className="relative py-32 md:py-44 overflow-hidden" style={{ background: DARK }}>
        <div className="relative z-10 max-w-4xl mx-auto px-8 md:px-16 text-center">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.h2 variants={fadeUp} className="font-estate text-4xl md:text-6xl lg:text-7xl font-light leading-[1.05] mb-8" style={{ color: IVORY }}>

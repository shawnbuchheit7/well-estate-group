      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col justify-center overflow-hidden" style={{ background: DARK }}>
        ...
        <motion.div className="relative z-10 px-6 md:px-12 max-w-7xl mx-auto w-full text-center" style={{ y: heroY, opacity: heroOpacity }}>
          <motion.div initial="hidden" animate="visible" variants={stagger}>
            ...
            <motion.h1 variants={fadeUp} className="text-[clamp(2.5rem,6vw,5rem)] tracking-[0.15em] uppercase mb-12" style={{ color: IVORY, fontFamily: "'Bodoni Moda', serif", fontWeight: 900, fontVariationSettings: "'opsz' 48" }}>
              THE ESTATE
            </motion.h1>
            ...
            {/* 7 Core Pillars — square cards, equal width, text aligned consistently */}
            <motion.div variants={fadeUp} className="grid grid-cols-7 gap-3 mb-20 mt-4 w-full">
              {[
                ...
                <div key={i} className="aspect-square flex flex-col items-center text-center px-5 pt-10 pb-8 rounded-2xl border" style={{ borderColor: 'rgba(250,247,242,0.12)', backgroundColor: 'rgba(250,247,242,0.03)' }}>
                  <p className="font-estate-sans text-[13px] font-semibold tracking-[0.18em] uppercase mb-auto" style={{ color: IVORY }}>
                    {pillar.title}
                  </p>
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="mb-16 md:mb-20">
              ...
              <h2 className="font-estate-headline text-4xl md:text-6xl font-light" style={{ color: DARK }}>
          ...
          >
            ...
            <motion.div variants={fadeUp} className="grid md:grid-cols-3 gap-12 md:gap-16">
              {[
                ...
                <div key={i}>
                  <div className="font-estate-headline text-4xl md:text-5xl font-light mb-4" style={{ color: DARK }}>
                    {stat.value}
                  </div>
      ...
      <section className="relative py-32 md:py-44 overflow-hidden" style={{ background: DARK }}>
        <div className="relative z-10 max-w-4xl mx-auto px-8 md:px-16 text-center">
          <motion.div
            ...
            variants={stagger}
          >
            <motion.h2 variants={fadeUp} className="font-estate-headline text-4xl md:text-6xl lg:text-7xl font-light leading-[1.05] mb-8" style={{ color: IVORY }}>

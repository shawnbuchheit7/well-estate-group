/**
 * The Estate - Longevity Ventures Estate Business Model
 * Duplicated from Luxury Model — branding to be updated
...
const sections = [
  { title: "About", desc: "The vision behind The Estate and the market opportunity", path: "/longevity/estate/about" },
  { title: "Opportunity", desc: "Market size, growth drivers, and competitive landscape", path: "/longevity/estate/opportunity" },
  { title: "Memberships", desc: "Tiered membership model — Elite, Premier, and Essential", path: "/longevity/estate/memberships" },
  { title: "Therapeutics", desc: "Clinical protocols, treatment modalities, and wellness services", path: "/longevity/estate/therapeutics" },
  { title: "Technology", desc: "AI-powered diagnostics, wearable integration, and data platform", path: "/longevity/estate/technology" },
  { title: "Projections", desc: "Financial projections, unit economics, and growth trajectory", path: "/longevity/estate/projections" },
  { title: "Team", desc: "Hiring priorities, team structure, and capacity planning", path: "/longevity/estate/team" },
  { title: "FAQ", desc: "Frequently asked questions about the business model", path: "/longevity/estate/faq" },
];
...
export default function TheEstate() {
  return (
    <Layout>
      <LightHero
        eyebrow="The Estate"
        title={<>The Estate<br /><em className="italic font-light">Business Model</em></>}
        ...
        <div className="container">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="font-body text-base text-black/65 max-w-2xl mx-auto">
              Navigate through each section of The Estate business plan using the tabs above

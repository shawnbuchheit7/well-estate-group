...
export default function GTMResults() {
  return (
    <Layout section="gtm">
      ...
      <section id="nps" className="py-20 sm:py-24 bg-[#F9F9F7]">
        <div className="container px-6 sm:px-8">
          ...
          <motion.div
            ...
            variants={staggerContainer}
          >
            <motion.div variants={fadeInUp} className="bg-white border border-[#B8860B]/40 rounded-xl p-8 shadow-[0_2px_8px_rgba(0,0,0,0.03),0_8px_24px_rgba(0,0,0,0.05)]">
              ...
              <div className="grid md:grid-cols-3 gap-5">
                <div className="text-center p-5 rounded-xl bg-red-50 border border-red-100">
                  ...
                  <p className="font-body text-xs text-black/60 leading-relaxed">Unhappy customers who can damage your brand through negative word-of-mouth</p>
                </div>
              ...
              <div className="mt-6 text-center border-t border-[#B8860B]/40 pt-5">
          ...
          >
            {[
              ...
              >
                ...
                <p className="font-body text-sm text-black/65 leading-relaxed">{metric.description}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-body text-sm text-black/65 leading-relaxed">{method.description}</p>
                </div>
              </motion.div>
            ))}
          </motion.div>
      ...
      {/* CTA */}
      <section id="cta" className="py-20 sm:py-24 bg-white border-t border-[#B8860B]/40">
        <div className="container px-6 sm:px-8">
          <motion.div
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="font-body text-sm text-black/65 mt-4 mb-8 leading-relaxed">
            ...
            <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a href="mailto:shawn@wellestategroup.com" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg border border-[#B8860B]/40 text-black font-body text-sm font-semibold hover:border-[#B8860B]/60 hover:bg-[#F9F9F7] transition-all">
                Contact Us
              </a>
            </motion.div>
          </motion.div>

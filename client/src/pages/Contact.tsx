...
${formData.message || 'No additional message provided.'}
      ...
      // Open mailto link
      window.location.href = `mailto:invest@wellestategroup.com?subject=${subject}&body=${body}`;
    ...
    <Layout>
      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div 
          ...
          style={{ backgroundImage: "url('https://files.manuscdn.com/user_upload_by_module/session_file/310519663219582709/KPMIlTZkrMldpcFr.jpg')", backgroundSize: "cover", backgroundPosition: "center" }}
        />
                ...
                {isSubmitted ? (
                  <div className="bg-card border border-emerald-500/30 rounded-2xl p-12 text-center">
                    ...
                    <p className="font-body text-muted-foreground mb-6">
                      Thank you for your interest in Well Estate Group. Our investor relations team will review your 

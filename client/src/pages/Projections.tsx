              ...
              {[
                ...
                >
                  <AnimatedCounter 
                    ...
                    className="font-estate-headline text-3xl font-bold text-gradient"
                    duration={2.5 + i * 0.2}
                  />
                  <p className="font-estate-headline font-medium mt-2">{stat.label}</p>
                  <p className="font-estate-sans text-sm text-muted-foreground">{stat.subtext}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
        ...
        <div className="container">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-8">
              ...
              <h2 className="font-estate-headline text-3xl md:text-4xl font-medium mt-4 mb-4">
                5-Year Financial Summary
              </h2>
              <p className="font-estate-sans text-muted-foreground max-w-2xl mx-auto">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gradient-to-r from-primary/10 to-accent/10">
                      <th className="text-left p-4 font-estate-headline font-semibold text-foreground">Metric</th>
                      <th className="text-center p-4 font-estate-headline font-semibold text-muted-foreground">2027</th>
                      <th className="text-center p-4 font-estate-headline font-semibold text-muted-foreground">2028</th>
                      <th className="text-center p-4 font-estate-headline font-semibold text-muted-foreground">2029</th>
                      <th className="text-center p-4 font-estate-headline font-semibold text-muted-foreground">2030</th>
                      <th className="text-center p-4 font-estate-headline font-semibold text-primary bg-primary/10">2031</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="border-b border-border/50 bg-card">
                      <td className="p-4 font-estate-sans">
                        <div className="flex items-center gap-2">
                          <DollarSign className="w-4 h-4 text-primary" />
                          <span className="font-medium">Total Revenue</span>
                        </div>
                      </td>
                      <td className="p-4 text-center font-estate-sans">$20M</td>
                      <td className="p-4 text-center font-estate-sans">$40M</td>
                      <td className="p-4 text-center font-estate-sans">$100M</td>
                      <td className="p-4 text-center font-estate-sans">$200M</td>
                      <td className="p-4 text-center font-estate-sans text-primary font-bold bg-primary/5">$327M</td>
                    </tr>
                    <tr className="border-b border-border/50">
                      ...
                      <td className="p-4 text-center font-estate-sans">$7M</td>
                      <td className="p-4 text-center font-estate-sans">$14M</td>
                      <td className="p-4 text-center font-estate-sans">$35M</td>
                      <td className="p-4 text-center font-estate-sans">$69M</td>
                      <td className="p-4 text-center font-estate-sans text-emerald-400 font-bold bg-primary/5">$113M</td>
                    </tr>
                    <tr className="border-b border-border/50 bg-card">
                      <td className="p-4 font-estate-sans">
                        <div className="flex items-center gap-2">
                      ...
                      <td className="p-4 text-center font-estate-sans">34%</td>
                      <td className="p-4 text-center font-estate-sans">34%</td>
                      <td className="p-4 text-center font-estate-sans">34%</td>
                      <td className="p-4 text-center font-estate-sans">34%</td>
                      <td className="p-4 text-center font-estate-sans text-amber-500 font-bold bg-primary/5">34%</td>
                    </tr>
                    <tr className="border-b border-border/50">
                      <td className="p-4 font-estate-sans">
                        <div className="flex items-center gap-2">
                      ...
                      <td className="p-4 text-center font-estate-sans">500</td>
                      <td className="p-4 text-center font-estate-sans">977</td>
                      <td className="p-4 text-center font-estate-sans">2,428</td>
                      <td className="p-4 text-center font-estate-sans">4,820</td>
                      <td className="p-4 text-center font-estate-sans text-blue-400 font-bold bg-primary/5">7,863</td>
                    </tr>
                    <tr className="border-b border-border/50 bg-card">
                      <td className="p-4 font-estate-sans">
                        <div className="flex items-center gap-2">
                      ...
                      <td className="p-4 text-center font-estate-sans">1</td>
                      <td className="p-4 text-center font-estate-sans">2</td>
                      <td className="p-4 text-center font-estate-sans">4</td>
                      <td className="p-4 text-center font-estate-sans">7</td>
                      <td className="p-4 text-center font-estate-sans text-purple-400 font-bold bg-primary/5">10</td>
                    </tr>
                    <tr className="bg-card">
                      ...
                      <td className="p-4 text-center font-estate-sans">25</td>
                      <td className="p-4 text-center font-estate-sans">62</td>
                      <td className="p-4 text-center font-estate-sans">148</td>
                      <td className="p-4 text-center font-estate-sans">290</td>
                      <td className="p-4 text-center font-estate-sans text-cyan-400 font-bold bg-primary/5">580</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div className="p-4 bg-muted/30 border-t border-border flex items-center justify-between flex-wrap gap-4">
                <p className="font-estate-sans text-xs text-muted-foreground">
          ...
          >
            <motion.div variants={fadeInUp} className="bg-card border border-border rounded-2xl overflow-hidden">
              <div className="p-8 border-b border-border bg-muted/30">
                <h3 className="font-estate-headline text-2xl font-medium">Domestic Revenue Projections</h3>
                <p className="font-estate-sans text-muted-foreground">5-Year Financial Roadmap Based on Disciplined Center Rollout</p>
              </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border">
                      <th className="text-left p-5 font-estate-sans font-semibold text-muted-foreground">Metric</th>
                      <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">2027</th>
                      <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">2028</th>
                      <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">2029</th>
                      <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">2030</th>
                      <th className="text-center p-5 font-estate-sans font-semibold text-gradient">2031</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={i} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                        <td className="p-5 font-estate-sans font-medium">{row.metric}</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">{row.y1}</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">{row.y2}</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">{row.y3}</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">{row.y4}</td>
                        <td className="p-5 text-center font-estate-sans text-accent font-semibold">{row.y5}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
              ...
              <div className="p-6 bg-muted/20 border-t border-border">
                <p className="font-estate-sans text-sm text-muted-foreground">
            ...
            <motion.div variants={fadeInUp} className="bg-card border border-border rounded-2xl overflow-hidden">
              ...
              <div className="p-8 border-b border-border bg-muted/30">
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <label className="font-estate-headline font-medium">ELITE Membership Price</label>
                      <span className="font-estate-sans text-xl text-primary font-bold">${membershipPrice.toLocaleString()}</span>
                    </div>
                    <input
                      type="range"
                      min="20000"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <label className="font-estate-headline font-medium">ELITE Renewal Rate</label>
                      <span className="font-estate-sans text-xl text-primary font-bold">{renewalRate}%</span>
                    </div>
                    <input
                      type="range"
                      min="50"
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <label className="font-estate-headline font-medium">Number of Centers (2031)</label>
                      <span className="font-estate-sans text-xl text-primary font-bold">{centerCount}</span>
                    </div>
                    <input
                      type="range"
                      min="4"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <label className="font-estate-headline font-medium">New Members / Center / Year</label>
                      <span className="font-estate-sans text-xl text-primary font-bold">{growthRate}</span>
                    </div>
                    <input
                      type="range"
                      min="200"
              ...
              <div className="p-8">
                <div className="grid md:grid-cols-5 gap-4 mb-8">
                  <div className="bg-muted/30 rounded-xl p-5 text-center">
                    <span className="font-estate-sans text-2xl font-bold text-gradient">${adjustedRevenue}M</span>
                    <p className="font-estate-sans text-xs text-muted-foreground mt-2">2031 Revenue</p>
                    <p className={`font-estate-sans text-xs mt-1 ${adjustedRevenue >= baseRevenue ? 'text-emerald-400' : 'text-amber-400'}`}>
                      {adjustedRevenue >= baseRevenue ? '+' : ''}{adjustedRevenue - baseRevenue}M vs base
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded-xl p-5 text-center">
                    <span className="font-estate-sans text-2xl font-bold text-gradient">${adjustedEBITDA}M</span>
                    <p className="font-estate-sans text-xs text-muted-foreground mt-2">2031 EBITDA</p>
                    <p className={`font-estate-sans text-xs mt-1 ${adjustedEBITDA >= 113 ? 'text-emerald-400' : 'text-amber-400'}`}>
                      {adjustedEBITDA >= 113 ? '+' : ''}{adjustedEBITDA - 113}M vs base
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded-xl p-5 text-center">
                    <span className="font-estate-sans text-2xl font-bold text-foreground">{adjustedMembers.toLocaleString()}</span>
                    <p className="font-estate-sans text-xs text-muted-foreground mt-2">2031 Members</p>
                    <p className={`font-estate-sans text-xs mt-1 ${adjustedMembers >= 7863 ? 'text-emerald-400' : 'text-amber-400'}`}>
                      {adjustedMembers >= 7863 ? '+' : ''}{adjustedMembers - 7863} vs base
                    </p>
                  </div>
                  <div className="bg-muted/30 rounded-xl p-5 text-center">
                    <span className="font-estate-sans text-2xl font-bold text-foreground">${revenuePerCenter}M</span>
                    <p className="font-estate-sans text-xs text-muted-foreground mt-2">Revenue/Center</p>
                    <p className="font-estate-sans text-xs mt-1 text-muted-foreground">Avg per location</p>
                  </div>
                  <div className="bg-muted/30 rounded-xl p-5 text-center">
                    <span className="font-estate-sans text-2xl font-bold text-foreground">{breakEvenMembers}</span>
                    <p className="font-estate-sans text-xs text-muted-foreground mt-2">Break-Even</p>
                    <p className="font-estate-sans text-xs mt-1 text-muted-foreground">Members/center/yr</p>
                  </div>
                </div>

                {/* Scenario Comparison */}
                <div className="bg-primary/5 border border-primary/20 rounded-xl p-6">
                  <h4 className="font-estate-headline font-medium mb-4 flex items-center gap-2">
                    <BarChart3 className="w-5 h-5 text-primary" />
                    Exit Valuation Impact
                  </h4>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div>
                      <p className="font-estate-sans text-sm text-muted-foreground mb-1">Conservative (15x EBITDA)</p>
                      <span className="font-estate-sans text-2xl font-bold text-foreground">${(adjustedEBITDA * 15 / 1000).toFixed(1)}B</span>
                    </div>
                    <div>
                      <p className="font-estate-sans text-sm text-muted-foreground mb-1">Base Case (20x EBITDA)</p>
                      <span className="font-estate-sans text-2xl font-bold text-primary">${(adjustedEBITDA * 20 / 1000).toFixed(1)}B</span>
                    </div>
                    <div>
                      <p className="font-estate-sans text-sm text-muted-foreground mb-1">Optimistic (25x EBITDA)</p>
                      <span className="font-estate-sans text-2xl font-bold text-emerald-400">${(adjustedEBITDA * 25 / 1000).toFixed(1)}B</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="p-4 bg-muted/20 border-t border-border">
                <p className="font-estate-sans text-xs text-muted-foreground text-center">
          ...
          >
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-border bg-muted/30">
                      <th className="text-left p-5 font-estate-sans font-semibold text-muted-foreground">Quarter</th>
                      <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">New Centers</th>
                      <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">Total Centers</th>
                      <th className="text-left p-5 font-estate-sans font-semibold text-muted-foreground">Notes</th>
                    </tr>
                  </thead>
                  <tbody>
                    {[
                      ...
                      <tr key={i} className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                        <td className="p-5 font-estate-sans font-medium">{row.quarter}</td>
                        <td className="p-5 text-center">
                          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-primary/20 text-primary font-estate-sans font-bold">
                            +{row.new}
                          </span>
                        </td>
                        <td className="p-5 text-center font-estate-sans text-accent font-semibold">{row.total}</td>
                        <td className="p-5 font-estate-sans text-muted-foreground">{row.notes}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
            ...
            <motion.div variants={fadeInUp} className="mb-12">
              <div className="text-center mb-8">
                <h3 className="font-estate-headline text-2xl font-medium mb-4">Two Distinct Growth Pathways</h3>
                <p className="font-estate-sans text-muted-foreground max-w-3xl mx-auto">
                  Well Estate Group's expansion strategy encompasses two complementary pathways: center development for the full Well Estate Group experience, 
                ...
                <div className="bg-card border-2 border-primary/30 rounded-2xl overflow-hidden">
                  <div className="p-6 bg-primary/5 border-b border-primary/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-estate-headline text-xl font-medium">Center Development</h4>
                        <p className="font-estate-sans text-xs text-primary">Full Well Estate Group Experience</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-6">
                    <p className="font-estate-sans text-muted-foreground text-sm mb-6">
                      Physical Well Estate Group centers delivering the complete membership experience including diagnostics, 
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <span className="font-estate-sans text-sm font-medium">Domestic Expansion</span>
                          <p className="font-estate-sans text-xs text-muted-foreground">10 owned centers by 2031 in major U.S. metros</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <Handshake className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                        <div>
                          <span className="font-estate-sans text-sm font-medium">International Franchise</span>
                          <p className="font-estate-sans text-xs text-muted-foreground">Partner-operated centers with brand, protocols, and biologics supply</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <Users className="w-4 h-4 text-primary mt-1 flex-shrink-0" />
                        <div>
                          <span className="font-estate-sans text-sm font-medium">Joint Ventures</span>
                          <p className="font-estate-sans text-xs text-muted-foreground">Shared ownership with regional healthcare groups</p>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-card border-2 border-amber-500/30 rounded-2xl overflow-hidden">
                  <div className="p-6 bg-amber-500/5 border-b border-amber-500/20">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="font-estate-headline text-xl font-medium">Therapeutics Product Licensing</h4>
                        <p className="font-estate-sans text-xs text-amber-500">Massive Additional Opportunity</p>
                      </div>
                    </div>
                  </div>
                  <div className="p-6">
                    <p className="font-estate-sans text-muted-foreground text-sm mb-6">
                      License Well Estate Group's proprietary therapeutics—including MUSE Cell technology, biologics formulations, 
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          <span className="font-estate-sans text-sm font-medium">Asset-Light Model</span>
                          <p className="font-estate-sans text-xs text-muted-foreground">No capital investment in physical centers required</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <Globe className="w-4 h-4 text-amber-500 mt-1 flex-shrink-0" />
                        <div>
                          <span className="font-estate-sans text-sm font-medium">Global Reach</span>
                          <p className="font-estate-sans text-xs text-muted-foreground">License to hospitals, clinics, and medical groups worldwide</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <DollarSign className="w-4 h-4 text-amber-500 mt-1 flex-shrink-0" />
                        <div>
                          <span className="font-estate-sans text-sm font-medium">Recurring Revenue</span>
                          <p className="font-estate-sans text-xs text-muted-foreground">License fees, royalties, and biologics supply contracts</p>
                        </div>
                      </div>
                    </div>
                    {/* Business Plan Outline */}
                    <div className="mt-6 pt-6 border-t border-amber-500/20">
                      <h5 className="font-estate-headline text-sm font-medium mb-4 flex items-center gap-2">
                        <FileText className="w-4 h-4 text-amber-500" />
                        Business Plan Development Outline
                      </h5>
                      <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-muted/30 rounded-lg p-3">
                          <h6 className="font-estate-sans text-xs text-amber-500 mb-2">Market Analysis</h6>
                        ...
                        <div className="bg-muted/30 rounded-lg p-3">
                          <h6 className="font-estate-sans text-xs text-amber-500 mb-2">Pricing & Revenue Model</h6>
                          <ul className="text-xs text-muted-foreground space-y-1">
                        ...
                        <div className="bg-muted/30 rounded-lg p-3">
                          <h6 className="font-estate-sans text-xs text-amber-500 mb-2">Operations & Support</h6>
                          <ul className="text-xs text-muted-foreground space-y-1">
                        ...
                        <div className="bg-muted/30 rounded-lg p-3">
                          <h6 className="font-estate-sans text-xs text-amber-500 mb-2">Financial Projections</h6>
                          <ul className="text-xs text-muted-foreground space-y-1">
                      ...
                      <div className="mt-4 p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg">
                        <p className="font-estate-sans text-xs text-amber-200">
            ...
            <motion.div variants={fadeInUp}>
              ...
              <p className="font-estate-sans text-muted-foreground mb-8">
                ...
                {[
                  {
                    icon: Building2,
                    title: "Owned Centers",
                    description: "Fully owned and operated Well Estate Group centers in major U.S. markets. Maximum control over member experience and operations.",
                    benefits: ["Full revenue capture", "Brand control", "Operational excellence", "Premium market positioning"]
                  },
                  {
                    icon: Handshake,
                    title: "Franchise Model",
                    description: "Partner with established healthcare operators in target markets. Well Estate Group provides brand, protocols, training, and biologics supply.",
                  ...
                  <div key={i} className="bg-card border border-border rounded-2xl p-6 hover:border-primary/50 transition-colors">
                    ...
                    <h4 className="font-estate-headline text-xl font-medium mb-3">{model.title}</h4>
                    <p className="font-estate-sans text-muted-foreground text-sm mb-4">{model.description}</p>
                      ...
                      {[
                        ...
                        <div key={i} className="p-4 bg-muted/30 rounded-xl">
                          <div className="flex items-center justify-between mb-2">
                            <span className="font-estate-headline font-medium">{item.market}</span>
                            <span className="font-estate-sans text-xs text-primary">{item.hnw} HNW</span>
                          </div>
                  ...
                  <div className="bg-card border border-amber-500/30 rounded-2xl p-6">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={i} className="p-4 bg-muted/30 rounded-xl">
                          <div className="flex items-center justify-between mb-2">
                            <span className="font-estate-headline font-medium">{item.region}</span>
                            <span className="font-estate-sans text-xs text-amber-500">{item.model}</span>
                          </div>
                ...
                <div className="mt-8 grid md:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={i} className="bg-muted/30 rounded-xl p-4 text-center">
                      <span className="font-estate-sans text-sm text-primary">{item.criteria}</span>
      ...
      <section className="py-20 bg-card/30">
        <div className="container">
          ...
          >
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border bg-muted/30">
                        <th className="text-left p-4 font-estate-headline font-medium">Metric</th>
                        <th className="text-right p-4 font-estate-headline font-medium">2027</th>
                        <th className="text-right p-4 font-estate-headline font-medium">2028</th>
                        <th className="text-right p-4 font-estate-headline font-medium">2029</th>
                        <th className="text-right p-4 font-estate-headline font-medium">2030</th>
                        <th className="text-right p-4 font-estate-headline font-medium">2031</th>
                      </tr>
                    </thead>
                    <tbody className="font-estate-sans">
                      <tr className="border-b border-border/50">
                        <td className="p-4 font-medium">Operating Centers</td>
                        <td className="p-4 text-right font-estate-sans">1</td>
                        <td className="p-4 text-right font-estate-sans">2</td>
                        <td className="p-4 text-right font-estate-sans">4</td>
                        <td className="p-4 text-right font-estate-sans">7</td>
                        <td className="p-4 text-right font-estate-sans text-primary font-medium">10</td>
                      </tr>
                      ...
                      <tr className="bg-[#1A1A1A]/10">
                        ...
                        <td className="p-4 text-right font-estate-sans text-amber-400">($0.9M)</td>
                        <td className="p-4 text-right font-estate-sans text-emerald-400">$0.2M</td>
                        <td className="p-4 text-right font-estate-sans text-emerald-400">$4.0M</td>
                        <td className="p-4 text-right font-estate-sans text-emerald-400">$10.5M</td>
                        <td className="p-4 text-right font-estate-sans text-emerald-400 font-bold">$19.2M</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <motion.div variants={fadeInUp} className="mb-12">
              <h3 className="font-estate-headline text-2xl font-medium mb-6">Management Fee Allocation</h3>
              ...
              <div className="grid md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-card border border-border rounded-xl p-4">
                    <div className="text-2xl font-estate-sans font-bold text-primary mb-1">{item.pct}</div>
                    <div className="font-estate-headline font-medium text-sm mb-1">{item.label}</div>
                    <div className="font-estate-sans text-xs text-muted-foreground mb-2">{item.amount} (2031)</div>
            ...
            {/* Breakeven Analysis */}
            <motion.div variants={fadeInUp}>
              <h3 className="font-estate-headline text-2xl font-medium mb-6">HoldCo Breakeven Analysis</h3>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="bg-card border border-border rounded-2xl p-6 text-center">
                  <div className="text-4xl font-estate-sans font-bold text-primary mb-2">$4.6M</div>
                  <div className="font-estate-headline font-medium">Mgmt Fee / Mature Center</div>
                  <div className="text-sm text-muted-foreground">8% of $57.5M revenue</div>
                </div>
                <div className="bg-card border border-border rounded-2xl p-6 text-center">
                  <div className="text-4xl font-estate-sans font-bold text-primary mb-2">$2.5M</div>
                  <div className="font-estate-headline font-medium">Base Corporate Overhead</div>
                  <div className="text-sm text-muted-foreground">Fixed costs (executive, legal)</div>
                </div>
                <div className="bg-[#1A1A1A]/10 border border-emerald-500/30 rounded-2xl p-6 text-center">
                  <div className="text-4xl font-estate-sans font-bold text-emerald-400 mb-2">2027</div>
                  <div className="font-estate-headline font-medium text-emerald-400">HoldCo Breakeven Year</div>
          ...
          >
                ...
                {[
                  ...
                  >
                    <div className="flex items-center gap-2 mb-4">
                      ...
                      <span className={`font-estate-headline font-medium ${item.color}`}>{item.scenario}</span>
                    </div>
                    
                    <div className="space-y-2 mb-6">
                      {item.assumptions.map((assumption, j) => (
                        <p key={j} className="font-estate-sans text-sm text-muted-foreground">• {assumption}</p>
                      ))}
                    </div>
                    
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-border">
                      <div className="text-center">
                        <span className="font-estate-sans text-lg font-bold text-foreground">{item.revenue}</span>
                        <p className="font-estate-sans text-xs text-muted-foreground">Revenue</p>
                      </div>
                      <div className="text-center">
                        <span className="font-estate-sans text-lg font-bold text-foreground">{item.ebitda}</span>
                        <p className="font-estate-sans text-xs text-muted-foreground">EBITDA</p>
                      </div>
                      <div className="text-center">
                        <span className="font-estate-sans text-lg font-bold text-foreground">{item.margin}</span>
                        <p className="font-estate-sans text-xs text-muted-foreground">Margin</p>
                      </div>
                    </div>
                  </div>
                ))}
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border bg-muted/30">
                        <th className="text-left p-5 font-estate-sans font-semibold text-muted-foreground">Scenario</th>
                        <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">Revenue</th>
                        <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">EBITDA</th>
                        <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">Members</th>
                        <th className="text-center p-5 font-estate-sans font-semibold text-muted-foreground">Key Drivers</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-border/50 hover:bg-muted/20 transition-colors">
                        <td className="p-5">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="font-estate-sans font-medium">Bear Case</span>
                          </div>
                        </td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">$260M</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">$85M</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">6,680</td>
                        <td className="p-5 text-center font-estate-sans text-sm text-muted-foreground">Lower pricing, slower adoption</td>
                      </tr>
                      <tr className="border-b border-border/50 bg-primary/5 hover:bg-primary/10 transition-colors">
                        <td className="p-5">
                          <div className="flex items-center gap-2">
                            <Target className="w-4 h-4 text-primary" />
                            <span className="font-estate-sans font-medium text-primary">Base Case</span>
                          </div>
                        </td>
                        <td className="p-5 text-center font-estate-sans font-semibold text-primary">$327M</td>
                        <td className="p-5 text-center font-estate-sans font-semibold text-primary">$113M</td>
                        <td className="p-5 text-center font-estate-sans font-semibold text-primary">7,863</td>
                        <td className="p-5 text-center font-estate-sans text-sm text-primary">Current assumptions</td>
                      </tr>
                      <tr className="hover:bg-muted/20 transition-colors">
                        <td className="p-5">
                          <div className="flex items-center gap-2">
                            <ArrowUpRight className="w-4 h-4 text-green-400" />
                            <span className="font-estate-sans font-medium">Bull Case</span>
                          </div>
                        </td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">$410M</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">$148M</td>
                        <td className="p-5 text-center font-estate-sans text-muted-foreground">9,040</td>
                        <td className="p-5 text-center font-estate-sans text-sm text-muted-foreground">Premium pricing, faster growth</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <motion.div variants={fadeInUp} className="mt-8 bg-card border border-border rounded-2xl p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-estate-headline font-medium mb-2">Key Sensitivity Drivers</h4>
                  <div className="grid md:grid-cols-3 gap-4 font-estate-sans text-sm text-muted-foreground">
                    <div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-5 gap-6">
              {[
                ...
                <div key={i} className="bg-card border border-border rounded-2xl p-6 hover:border-primary/50 transition-colors">
                  <span className="font-estate-headline text-3xl font-bold text-gradient">{item.year}</span>
              ...
              {[
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-estate-headline text-3xl font-bold text-gradient">{item.year}</span>
                    <span className="font-estate-sans text-xs text-muted-foreground">{item.centers}</span>
                  </div>
                  
                  <div className="space-y-4">
                    <div className="flex justify-between items-center pb-3 border-b border-border/50">
                      <span className="font-estate-sans text-muted-foreground">Network EBITDA</span>
                      <span className="font-estate-sans font-medium">{item.ebitda}</span>
                    </div>
                    <div className="flex justify-between items-center pb-3 border-b border-border/50">
                      <span className="font-estate-sans text-muted-foreground">Enterprise Value</span>
                      <span className="font-estate-sans font-bold text-primary">{item.valuation}</span>
                    </div>
                    <div className="flex justify-between items-center pb-3 border-b border-border/50">
                      <span className="font-estate-sans text-muted-foreground">MOIC</span>
                      <span className="font-estate-sans font-medium text-emerald-400">{item.moic}</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="font-estate-sans text-muted-foreground">IRR</span>
                      <span className="font-estate-sans font-bold text-emerald-400">{item.irr}</span>
                    </div>
                  </div>
                </div>
              ))}
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border bg-muted/30">
                        <th className="text-left p-4 font-estate-headline font-medium">EBITDA Multiple</th>
                        <th className="text-center p-4 font-estate-headline font-medium">Enterprise Value</th>
                        <th className="text-center p-4 font-estate-headline font-medium">MOIC</th>
                        <th className="text-center p-4 font-estate-headline font-medium">IRR</th>
                      </tr>
                    </thead>
                    <tbody className="font-estate-sans">
                      {[
                        ...
                        <tr key={i} className={`border-b border-border/50 ${row.highlight ? 'bg-primary/5' : ''}`}>
                          ...
                          <td className="p-4 text-center font-estate-sans">{row.value}</td>
                          <td className="p-4 text-center font-estate-sans text-emerald-400">{row.moic}</td>
                          <td className="p-4 text-center font-estate-sans font-bold text-emerald-400">{row.irr}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-4 gap-4">
              {[
                ...
                <div key={i} className="bg-card border border-border rounded-xl p-4 text-center">
                  ...
                  <span className={`font-estate-sans text-2xl font-bold ${item.color}`}>{item.value}</span>
                  <p className="font-estate-sans text-xs text-muted-foreground mt-1">{item.label}</p>
                </div>
              ))}
            </motion.div>
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border bg-muted/30">
                        <th className="text-left p-4 font-estate-headline font-medium">Company</th>
                        <th className="text-center p-4 font-estate-headline font-medium">Sector</th>
                        <th className="text-center p-4 font-estate-headline font-medium">EV/Revenue</th>
                        <th className="text-center p-4 font-estate-headline font-medium">EV/EBITDA</th>
                        <th className="text-center p-4 font-estate-headline font-medium">Revenue Growth</th>
                      </tr>
                    </thead>
                    <tbody className="font-estate-sans">
                      {[
                        ...
                        <tr key={i} className="border-b border-border/50">
                          ...
                          <td className="p-4 text-center font-estate-sans">{row.evRev}</td>
                          <td className="p-4 text-center font-estate-sans">{row.evEbitda}</td>
                          <td className="p-4 text-center font-estate-sans text-emerald-400">{row.growth}</td>
                        </tr>
                      ))}
                      <tr className="bg-primary/5 font-medium">
                        <td className="p-4 text-primary">Well Estate Group (Implied)</td>
                        <td className="p-4 text-center text-primary text-sm">Regenerative Medicine</td>
                        <td className="p-4 text-center font-estate-sans text-primary">7.0x</td>
                        <td className="p-4 text-center font-estate-sans text-primary">20x</td>
                        <td className="p-4 text-center font-estate-sans text-primary">30%+</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                <div className="p-4 bg-muted/20 border-t border-border">
                  <p className="font-estate-sans text-xs text-muted-foreground">
                    <strong className="text-foreground">Valuation Support:</strong> Well Estate Group's 20x EBITDA multiple is conservative relative to high-growth telehealth (HIMS at 35x) and premium to mature home health providers. 
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-3 gap-6">
              {[
                ...
                >
                  ...
                  <h3 className="font-estate-headline text-xl font-medium mb-3">{item.title}</h3>
                  <p className="font-estate-sans text-muted-foreground">{item.description}</p>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto space-y-4">
            <div className="bg-card border border-border rounded-xl p-5">
              <p className="font-estate-sans text-xs text-muted-foreground leading-relaxed">
        ...
        slides={[
          {
            ...
            content: (
              <div className="space-y-6">
                <h2 className="font-estate-headline text-4xl font-medium text-center mb-8">Growth Projections Overview</h2>
                <div className="grid md:grid-cols-4 gap-6">
                  {[
                    ...
                    <div key={i} className="bg-card border border-border rounded-2xl p-6 text-center">
                      <span className="font-estate-sans text-4xl font-bold text-gradient">{item.value}</span>
                      <p className="font-estate-headline font-medium mt-2">{item.label}</p>
                      <p className="font-estate-sans text-sm text-muted-foreground">{item.subtext}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          },
          {
            ...
            content: (
              <div className="space-y-6">
                <h2 className="font-estate-headline text-3xl font-medium">Domestic Revenue Projections</h2>
                <p className="text-muted-foreground">5-Year Financial Roadmap Based on Disciplined Center Rollout</p>
                <div className="bg-card border border-border rounded-2xl overflow-hidden">
                  <table className="w-full">
                    <thead>
                      <tr className="border-b border-border bg-muted/30">
                        <th className="text-left p-5 font-estate-sans font-semibold">Metric</th>
                        <th className="text-center p-5 font-estate-sans font-semibold">2027</th>
                        <th className="text-center p-5 font-estate-sans font-semibold">2028</th>
                        <th className="text-center p-5 font-estate-sans font-semibold">2029</th>
                        <th className="text-center p-5 font-estate-sans font-semibold">2030</th>
                        <th className="text-center p-5 font-estate-sans font-semibold text-primary">2031</th>
                      </tr>
                    </thead>
                    <tbody>
                      {[
                        ...
                        <tr key={i} className="border-b border-border/50">
                          <td className="p-5 font-estate-sans font-medium">{row.metric}</td>
                          <td className="p-5 text-center font-estate-sans">{row.y1}</td>
                          <td className="p-5 text-center font-estate-sans">{row.y2}</td>
                          <td className="p-5 text-center font-estate-sans">{row.y3}</td>
                          <td className="p-5 text-center font-estate-sans">{row.y4}</td>
                          <td className="p-5 text-center font-estate-sans text-primary font-bold">{row.y5}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          },
          {
            ...
            content: (
              <div className="space-y-6">
                <h2 className="font-estate-headline text-3xl font-medium text-center">Center Rollout Timeline</h2>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      <div key={i} className="text-center p-6 bg-muted/30 rounded-xl">
                        <span className="font-estate-sans text-sm text-primary">{item.year}</span>
                        <div className="font-estate-headline text-5xl font-bold my-2">{item.centers}</div>
                        <p className="font-estate-sans text-sm text-muted-foreground">{item.label}</p>
                      </div>
                    ))}
                  </div>
                </div>
          ...
          },
          {
            ...
            content: (
              <div className="space-y-6">
                <h2 className="font-estate-headline text-3xl font-medium text-center">Investor Return Analysis</h2>
                ...
                <div className="grid md:grid-cols-4 gap-6">
                  {[
                    ...
                    <div key={i} className="bg-card border border-border rounded-2xl p-6 text-center">
                      <span className={`font-estate-sans text-4xl font-bold ${item.color}`}>{item.value}</span>
                      <p className="font-estate-sans mt-2 text-muted-foreground">{item.label}</p>
                    </div>
                  ))}
                </div>
                <div className="bg-primary/10 border border-primary/20 rounded-xl p-6 mt-6">
                  <p className="font-estate-sans text-center text-muted-foreground">
          ...
          },
          {
            ...
            content: (
              <div className="space-y-6">
                <h2 className="font-estate-headline text-3xl font-medium text-center">Investment Highlights</h2>
                <div className="grid md:grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={i} className="bg-card border border-border rounded-2xl p-6">
                      <h3 className="font-estate-headline text-xl font-medium mb-2 text-primary">{item.title}</h3>
                      <p className="font-estate-sans text-muted-foreground">{item.desc}</p>
                    </div>
                  ))}
                </div>
              </div>

 ...
 * Full-viewport sections, clean white premium theme, WEG typography (Playfair, DM Sans, Space Mono)
 * Gold accent (#B8860B), white backgrounds, elegant data presentation
...
export default function CorporateHealth() {
  ...
  return (
    <div className="bg-white text-[#0a0a0a] min-h-screen relative">
      ...
      {/* Fixed Header */}
      <header className="fixed top-11 left-0 right-0 z-50 px-8 py-5 flex items-center justify-between bg-white/80 backdrop-blur-md border-b border-black/[0.06]">
        <div className="flex items-center gap-3">
          <img
            src="/weg-logo-mark-dark.png"
            alt="Well Estate Group"
            className="w-7 h-7 no-sharpen"
            style={{ imageRendering: "auto" }}
          />
          <span className="font-mono text-xs tracking-[0.2em] text-[#0a0a0a]/90 uppercase">Well Estate Group</span>
        </div>
        <span className="font-mono text-[10px] tracking-[0.15em] text-[#0a0a0a]/40 uppercase hidden md:block">
          ...
          <button
            ...
            className={`text-[9px] font-mono tracking-[0.15em] uppercase text-right px-3 py-1.5 rounded transition-all duration-300 ${
              activeSection === s.id
                ...
                : "text-[#0a0a0a]/25 hover:text-[#0a0a0a]/50"
            }`}
          >
            {s.label}
          </button>
      ...
      <section id="cover" className="min-h-screen flex flex-col justify-center relative overflow-hidden px-8 md:px-16 pt-32">
        {/* Background */}
        <div className="absolute inset-0 bg-gradient-to-br from-white via-[#fafafa] to-white" />
        <div className="absolute inset-0 opacity-30" style={{ backgroundImage: "radial-gradient(ellipse at 70% 50%, rgba(184,134,11,0.06) 0%, transparent 60%)" }} />
        ...
        <div className="relative z-10 max-w-5xl">
          <motion.div initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.p variants={fadeInUp} className="font-body text-base md:text-lg text-[#0a0a0a]/50 max-w-xl leading-relaxed mb-16">
            ...
            <motion.div variants={fadeInUp} className="flex flex-wrap gap-12 border-t border-black/[0.08] pt-8">
              {[
                ...
                <div key={item.label}>
                  <span className="font-mono text-[9px] tracking-[0.2em] text-[#0a0a0a]/30 uppercase block mb-1">{item.label}</span>
                  <span className="font-body text-sm text-[#0a0a0a]/80">{item.value}</span>
                </div>
              ))}
            </motion.div>
          </motion.div>
        ...
        <div className="absolute right-8 md:right-16 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-10 items-end">
          {[
            ...
            <div key={stat.label} className="text-right">
              ...
              <div className="font-mono text-[9px] tracking-[0.2em] text-[#0a0a0a]/30 mt-1">{stat.label}</div>
            </div>
          ))}
        </div>
        ...
        >
          <span className="font-mono text-[9px] tracking-[0.2em] text-[#0a0a0a]/25 uppercase">Scroll</span>
          <div className="w-[1px] h-8 bg-gradient-to-b from-[#0a0a0a]/20 to-transparent" />
        </motion.div>
      </section>
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">02 / EXECUTIVE THESIS</span>
            </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              <motion.div variants={fadeInUp} className="space-y-6">
                <p className="font-body text-[15px] text-[#0a0a0a]/55 leading-[1.8]">
              ...
              <motion.div variants={fadeInUp}>
                <blockquote className="border-l-2 border-[#B8860B]/40 pl-6 mb-12">
                  <p className="font-display text-xl md:text-2xl font-light italic text-[#0a0a0a]/60 leading-relaxed">
            ...
            {/* Stats Grid */}
            <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-16 pt-16 border-t border-black/[0.06]">
              {[
                ...
                <div key={stat.title} className="p-6 rounded-xl border border-black/[0.06] bg-[#fafafa]">
                  <div className="font-display text-3xl font-light text-[#B8860B] mb-3">{stat.value}</div>
                  <div className="font-body text-sm font-medium text-[#0a0a0a]/80 mb-2">{stat.title}</div>
                  <div className="font-body text-xs text-[#0a0a0a]/40 leading-relaxed">{stat.desc}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <section id="detect" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">03 / DETECT & REVERSE</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div key={stat.label} className="p-6 rounded-xl border border-black/[0.06] bg-[#fafafa] hover:border-[#B8860B]/30 transition-colors duration-300">
                  <div className="font-display text-3xl md:text-4xl font-light text-[#B8860B] mb-4">{stat.value}</div>
                  <div className="font-body text-sm font-medium text-[#0a0a0a]/80 mb-2">{stat.label}</div>
                  <div className="font-body text-xs text-[#0a0a0a]/40 leading-relaxed">{stat.detail}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <section id="paradigm" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">04 / PARADIGM SHIFT</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="relative">
              ...
              <div className="flex flex-col items-center mb-10">
                <div className="w-32 h-32 rounded-full border-2 border-[#B8860B]/40 flex flex-col items-center justify-center bg-[#B8860B]/[0.05]">
                  ...
                  <span className="font-mono text-[8px] tracking-wider text-[#0a0a0a]/40 mt-1">15B+ DATA POINTS</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {[
                  ...
                  <div key={item.step} className="text-center p-5 rounded-xl border border-black/[0.06] bg-[#fafafa]">
                    <div className="font-mono text-[9px] tracking-[0.2em] text-[#B8860B]/60 mb-2">{String(i + 1).padStart(2, "0")}</div>
                    <div className="font-display text-sm font-medium text-[#0a0a0a]/90 mb-1">{item.step}</div>
                    <div className="font-body text-[11px] text-[#0a0a0a]/40">{item.desc}</div>
                  </div>
                ))}
              </div>
            </motion.div>
      ...
      <section id="evidence" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">05 / EVIDENCE</span>
            </motion.div>
            ...
            <motion.p variants={fadeInUp} className="font-body text-[15px] text-[#0a0a0a]/50 max-w-3xl leading-[1.8] mb-12">
            ...
            {/* Top Stats */}
            <motion.div variants={fadeInUp} className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 p-8 rounded-2xl border border-black/[0.06] bg-[#fafafa]">
              {[
                ...
                <div key={stat.label} className="text-center">
                  ...
                  <div className="font-mono text-[8px] tracking-[0.2em] text-[#0a0a0a]/35 mt-2">{stat.label}</div>
                </div>
              ))}
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-3 gap-6">
              {/* Brain Performance */}
              <div className="p-6 rounded-xl border border-black/[0.06] bg-[#fafafa]">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.label} className="flex justify-between items-center">
                      <span className="font-body text-xs text-[#0a0a0a]/50">{item.label}</span>
            ...
            <motion.p variants={fadeInUp} className="font-mono text-[9px] text-[#0a0a0a]/25 tracking-wider mt-8">
      ...
      <section id="hallmarks" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">06 / THE SCIENCE</span>
            </motion.div>
            ...
            <motion.p variants={fadeInUp} className="font-body text-[15px] text-[#0a0a0a]/50 max-w-3xl leading-[1.8] mb-6">
            ...
            <motion.div variants={fadeInUp} className="flex gap-12 mb-14">
              {[
                ...
                <div key={stat.label}>
                  ...
                  <div className="font-mono text-[8px] tracking-[0.2em] text-[#0a0a0a]/30 mt-1">{stat.label}</div>
                </div>
              ))}
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={group.category} className="p-6 rounded-xl border border-black/[0.06] bg-[#fafafa]">
                  <h3 className="font-display text-lg font-medium text-[#0a0a0a]/90 mb-1">{group.category}</h3>
                  <p className="font-mono text-[9px] tracking-wider text-[#0a0a0a]/30 mb-5">{group.subtitle}</p>
                  <div className="space-y-3">
                    {group.items.map((item) => (
                      <div key={item} className="flex items-center gap-3">
                        <div className="w-1.5 h-1.5 rounded-full bg-[#B8860B]/50" />
                        <span className="font-body text-sm text-[#0a0a0a]/60">{item}</span>
                      </div>
                    ))}
                  </div>
                </div>
      ...
      <section id="cases" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">07 / CASE STUDIES</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={c.role} className="p-6 rounded-xl border border-black/[0.06] bg-[#fafafa] hover:border-[#B8860B]/30 transition-colors duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <span className="font-display text-base font-medium text-[#0a0a0a]/90">{c.role}</span>
                      <span className="font-mono text-[10px] text-[#0a0a0a]/30 ml-2">Age {c.age}</span>
                    </div>
                    <span className={`font-mono text-[8px] tracking-[0.15em] uppercase px-2 py-1 rounded ${
                      c.severity === "Critical" ? "bg-red-500/10 text-red-600/70" :
                      c.severity === "High" ? "bg-orange-500/10 text-orange-600/70" :
                      "bg-yellow-500/10 text-yellow-600/70"
                    }`}>{c.severity}</span>
                  </div>
                  <div className="font-mono text-[9px] tracking-[0.15em] text-[#B8860B]/60 uppercase mb-3">{c.domain}</div>
                  <p className="font-body text-xs text-[#0a0a0a]/50 leading-relaxed mb-3">{c.finding}</p>
                  <div className="border-t border-black/[0.06] pt-3">
                    <p className="font-body text-xs text-[#0a0a0a]/70 leading-relaxed">{c.outcome}</p>
                  </div>
                </div>
              ))}
            </motion.div>
      ...
      <section id="platform" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">08 / PLATFORM</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-3 gap-6 mb-16">
              {[
                ...
                <div key={pillar.title} className="p-6 rounded-xl border border-[#B8860B]/20 bg-[#B8860B]/[0.03]">
                  ...
                  <p className="font-body text-sm text-[#0a0a0a]/50 leading-relaxed">{pillar.desc}</p>
                </div>
              ))}
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div key={cat.category} className="p-6 rounded-xl border border-black/[0.06] bg-[#fafafa]">
      ...
      <section id="therapeutics" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">09 / THERAPEUTICS</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-2 gap-8">
              ...
              <div className="p-8 rounded-2xl border border-[#B8860B]/20 bg-[#B8860B]/[0.03]">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    <div key={item.name}>
                      <h4 className="font-display text-base font-medium text-[#0a0a0a]/90 mb-1">{item.name}</h4>
                      <p className="font-body text-xs text-[#0a0a0a]/45 leading-relaxed">{item.desc}</p>
                    </div>
                  ))}
                </div>
              </div>
              ...
              {/* Precision */}
              <div className="p-8 rounded-2xl border border-black/[0.06] bg-[#fafafa]">
                <h3 className="font-mono text-[9px] tracking-[0.2em] text-[#0a0a0a]/40 uppercase mb-6">Precision Protocols</h3>
                <div className="space-y-5">
                  {[
      ...
      <section id="membership" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">10 / MEMBERSHIP</span>
            </motion.div>
              ...
              {[
                ...
                <div key={t.tier} className={`p-8 rounded-2xl border ${
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    <h3 className={`font-mono text-sm tracking-[0.15em] ${t.highlight ? "text-[#B8860B]" : "text-[#0a0a0a]/60"}`}>{t.tier}</h3>
                    {t.highlight && (
                      ...
                      <div key={i} className="flex items-start gap-3">
                        {i === 0 && f.startsWith("Everything") ? (
                          ...
                          <>
                            ...
                            <span className="font-body text-sm text-[#0a0a0a]/60">{f}</span>
                          </>
                        )}
                      </div>
                    ))}
      ...
      <section id="landscape" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">11 / COMPETITIVE LANDSCAPE</span>
            </motion.div>
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b border-black/[0.08]">
                    <th className="text-left font-mono text-[9px] tracking-[0.15em] text-[#0a0a0a]/30 uppercase py-4 pr-4 w-1/3">Capability</th>
                    <th className="text-center font-mono text-[9px] tracking-[0.15em] text-[#0a0a0a]/30 uppercase py-4 px-3">Annual Physical</th>
                    <th className="text-center font-mono text-[9px] tracking-[0.15em] text-[#0a0a0a]/30 uppercase py-4 px-3">Mayo Clinic</th>
                    <th className="text-center font-mono text-[9px] tracking-[0.15em] text-[#0a0a0a]/30 uppercase py-4 px-3">Princeton Longevity</th>
                ...
                <tbody>
                  {[
                    ...
                    <tr key={cap} className="border-b border-black/[0.04]">
                      <td className="font-body text-sm text-[#0a0a0a]/60 py-3 pr-4">{cap}</td>
                      <td className="text-center py-3"><X className="w-3.5 h-3.5 text-[#0a0a0a]/15 mx-auto" /></td>
                      <td className="text-center py-3">{i < 2 || i === 12 ? <Check className="w-3.5 h-3.5 text-[#0a0a0a]/30 mx-auto" /> : <X className="w-3.5 h-3.5 text-[#0a0a0a]/15 mx-auto" />}</td>
                      <td className="text-center py-3">{i < 3 || i === 12 ? <Check className="w-3.5 h-3.5 text-[#0a0a0a]/30 mx-auto" /> : <X className="w-3.5 h-3.5 text-[#0a0a0a]/15 mx-auto" />}</td>
      ...
      <section id="implementation" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">12 / IMPLEMENTATION</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-5 gap-4">
              {[
                ...
                <div key={item.step} className="p-6 rounded-xl border border-black/[0.06] bg-[#fafafa] text-center">
                  <div className="font-mono text-[10px] tracking-[0.2em] text-[#B8860B]/60 mb-3">{item.step}</div>
                  <h3 className="font-display text-base font-medium text-[#0a0a0a]/90 mb-3">{item.title}</h3>
                  <p className="font-body text-xs text-[#0a0a0a]/40 leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </motion.div>
          </motion.div>
      ...
      <section id="conviction" className="min-h-screen flex items-center relative px-8 md:px-16 py-24">
        ...
        <div className="relative z-10 max-w-6xl mx-auto w-full">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">13 / INVESTMENT CONVICTION</span>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
              {[
                ...
                <div key={stat.label} className="p-6 rounded-xl border border-[#B8860B]/20 bg-[#B8860B]/[0.03] text-center">
                  ...
                  <div className="font-body text-xs text-[#0a0a0a]/50">{stat.label}</div>
                </div>
              ))}
            </motion.div>

            <motion.div variants={fadeInUp} className="mt-16 p-8 rounded-2xl border border-black/[0.06] bg-[#fafafa]">
              <p className="font-body text-[15px] text-[#0a0a0a]/55 leading-[1.8] max-w-3xl">
              ...
              <p className="font-body text-[15px] text-[#0a0a0a]/55 leading-[1.8] max-w-3xl mt-4">
        ...
        <div className="relative z-10 text-center max-w-3xl">
          ...
          >
            <motion.div variants={fadeInUp} className="flex items-center justify-center gap-4 mb-6">
              <span className="font-mono text-[10px] tracking-[0.2em] text-[#0a0a0a]/30">14 / GET STARTED</span>
            </motion.div>
            ...
            <motion.p variants={fadeInUp} className="font-body text-[15px] text-[#0a0a0a]/50 leading-[1.8] mb-12">
            ...
            <motion.div variants={fadeInUp}>
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 rounded-full border border-[#B8860B] text-[#B8860B] font-mono text-xs tracking-[0.15em] uppercase hover:bg-[#B8860B] hover:text-white transition-all duration-300"
              >
                Schedule a Briefing
            ...
            {/* Bottom Stats */}
            <motion.div variants={fadeInUp} className="flex justify-center gap-12 mt-16 pt-12 border-t border-black/[0.06]">
              {[
                { value: "46%", label: "Brain Aging Reversed" },
                ...
                <div key={stat.label} className="text-center">
                  ...
                  <div className="font-mono text-[8px] tracking-[0.15em] text-[#0a0a0a]/30 mt-1">{stat.label}</div>
                </div>
              ))}
            </motion.div>
          </motion.div>
      ...
      {/* Footer */}
      <footer className="py-8 px-8 border-t border-black/[0.04]">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <span className="font-mono text-[9px] tracking-[0.15em] text-[#0a0a0a]/20 uppercase">Well Estate Group · 2026</span>
          <span className="font-mono text-[9px] tracking-[0.15em] text-[#0a0a0a]/20 uppercase">Confidential</span>
        </div>
      </footer>
    </div>
  );

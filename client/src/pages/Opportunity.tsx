...
export default function Opportunity() {
  return (
    <Layout>
          ...
          >
            {[
              ...
              <motion.div 
                ...
                transition={{ duration: 0.6, delay: index * 0.15, ease: [0.25, 0.46, 0.45, 0.94] as [number, number, number, number] }}
              ...
              {[
                {
                  ...
                  description: "Unlike competitors who source biologics externally, Well Estate Group owns its manufacturing—controlling quality, cost, and supply chain.",
      ...
      {/* Industry vs Well Estate Group Comparison */}
      <section className="py-20 bg-card/30">
        <div className="container">
          <motion.div 
            className="max-w-6xl mx-auto"

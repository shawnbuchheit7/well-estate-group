        ...
        <div className="container">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="font-body text-xl text-muted-foreground">
              Well Estate Group is built by founders who understand the intersection of 
          ...
          >
            <motion.div variants={fadeInUp}>
              <blockquote className="font-display text-3xl md:text-4xl font-medium leading-relaxed mb-8">
                "Well Estate Group represents the future of healthcare—where cutting-edge science meets 
              ...
              {[
                ...
                <div key={i} className={`bg-card border rounded-2xl p-6 ${doc.available ? 'border-border hover:border-primary/50' : 'border-border/50 opacity-60'} transition-colors`}>
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {doc.available ? (
                      <button 
                        onClick={() => toast.info("Document Placeholder", { description: "This document will be available once uploaded. Contact invest@wellestategroup.com for access." })}
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-body text-sm text-muted-foreground">
                      This presentation contains forward-looking statements regarding Well Estate Group's business strategy, financial projections, 

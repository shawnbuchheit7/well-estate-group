        ...
        <div className="container">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="font-body text-xl text-muted-foreground">
              Well Estate Group is pre-operational and will build a world-class team to execute 
        ...
        <div className="container">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-12">
              ...
              <p className="font-body text-lg text-muted-foreground max-w-3xl mx-auto">
                As Well Estate Group scales, these additional executive roles will be added 
              ...
              <div className="flex flex-col md:flex-row items-center gap-8">
                <div className="flex-1">
                  ...
                  <p className="font-body text-muted-foreground mb-4">
                    Well Estate Group has selected Witt/Kieffer as our exclusive executive search partner for Phase 1 leadership recruitment. 
        ...
        <div className="container">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-12">
              ...
              <p className="font-body text-lg text-muted-foreground max-w-2xl mx-auto">
                Strategic governance structure designed to guide Well Estate Group through rapid growth. 

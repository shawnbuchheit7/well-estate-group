        ...
        <div className="container">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="font-body text-xl text-muted-foreground">
              ...
              and establish Well Estate Group as the global leader in regenerative medicine.
            </motion.p>
          </motion.div>
        </div>
      </section>
                        ...
                        <div className="flex-1 h-10 bg-muted/30 rounded-lg overflow-hidden relative">
                          {item.type === "start" ? (
                            <motion.div 
                              ...
                              viewport={{ once: true }}
                              transition={{ duration: 0.8, delay: i * 0.1 + 0.2, ease: [0.25, 0.46, 0.45, 0.94] as [number, number, number, number] }}
                            >
                            ...
                            <>
                              ...
                              <motion.div 
                                ...
                                viewport={{ once: true }}
                                transition={{ duration: 0.6, delay: i * 0.1 + 0.4, ease: [0.25, 0.46, 0.45, 0.94] as [number, number, number, number] }}
                                style={{ 
        ...
        <div className="container">
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="font-body text-xl text-muted-foreground max-w-3xl mx-auto">
              Each Well Estate Group membership center follows a proven design template combining 
...
<div className="bg-card border border-border rounded-2xl overflow-hidden">
                <ImageLightbox
                  src="/images/well-estate-group-reception-1.jpg"
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <ImageLightbox
                  src="/images/well-estate-group-reception-4.jpg"
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="grid md:grid-cols-2 gap-6">
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <ImageLightbox
                  src="/images/well-estate-group-suite-1.jpg"
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                <ImageLightbox
                  src="/images/well-estate-group-suite-2.jpg"
            ...
            <motion.div variants={fadeInUp} className="bg-card border border-border rounded-2xl overflow-hidden">
              ...
              <div className="p-6">
                <p className="font-body text-muted-foreground mb-6">
                  Each Well Estate Group membership center features premium furniture and finishes from RH Contract, 
          ...
          >
            {[
              ...
              { 
                ...
                icon: Globe,
                desc: "Well Estate Group™ and Lumasome™ distribution to partners"
              }
            ].map((pillar, i) => (
            ...
            <motion.div variants={fadeInUp} className="bg-card border border-border rounded-2xl p-6">
              ...
              <div className="grid md:grid-cols-3 gap-4">
                <div className="bg-muted/30 rounded-xl p-4">
                  ...
                  <p className="font-body text-xs text-muted-foreground">
                    Partners invest in buildout; Well Estate Group provides brand, protocols, training, and biologics supply
                  </p>
                </div>
                <div className="bg-muted/30 rounded-xl p-4">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-12">
              ...
              <p className="font-body text-xl text-muted-foreground max-w-3xl mx-auto">
                ...
                creates a unique window for Well Estate Group to establish category leadership.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeInUp} className="bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 border border-primary/30 rounded-2xl p-8 text-center">
              ...
              <p className="font-body text-muted-foreground max-w-3xl mx-auto mb-6">
                ...
                and establish physician relationships. The Series A enables Well Estate Group to move decisively 

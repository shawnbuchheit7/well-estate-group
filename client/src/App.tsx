...
const EstatePipeline = lazy(() => import("./pages/EstatePipeline"));
            ...
            <Router base={base === "/" ? "" : base}>
              ...
              <Suspense fallback={<PageLoader />}>
                <Switch>
                  ...
                  <Route path="/longevity/estate/pipeline" component={() => <LongevityPasswordGate><EstatePipeline /></LongevityPasswordGate>} />

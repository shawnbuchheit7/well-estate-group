            ...
            >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  autoFocus
                  className="w-full pl-11 pr-12 py-3.5 bg-gray-50 border-[1.5px] border-[#B8860B]/50 rounded-xl font-body text-sm text-black placeholder:text-gray-300 focus:outline-none focus:border-[#B8860B] focus:ring-2 focus:ring-[#B8860B]/10 transition-all"
